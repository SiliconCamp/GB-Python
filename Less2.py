...
RandListLenght = random.randint(1, 100) # Определяем количество элементов в списке от 1 до 100 элементов
print("List lenght (elements):", RandListLenght)

RandList = []

while len(RandList) != RandListLenght:
    num = random.randint(1,50) # Генерируем элемент от 1 до 50
    RandList.append(num)
